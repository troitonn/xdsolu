  ...
  pt: [
    {
      ...
      tabSub: 'Recebíveis e Contratos',
      title: 'O trilho financeiro de quem fornece para o Estado.',
      description: 'Antecipação de recebíveis, capital de giro e garantias para empresas que fornecem para órgãos públicos, com análise ágil de recebíveis e contratos.',
      pills: ['Antecipação de recebíveis', 'Capital de giro', 'Garantias contratuais'],
      subcards: [
        {
          title: 'Análise de recebíveis e contratos',
          description: 'Leitura do instrumento contratual, do recebível e do histórico do órgão para definir limite e taxa competitiva sem travar o seu fluxo.',
  ...
  pt: [
    {
      ...
      description: 'Empresas com contratos vigentes e recebíveis emitidos que necessitam de antecipação previsível e garantias para suportar o ciclo de recebimento governamental.',
...
export const PROCESS_STEPS_BY_LANG: Record<Language, ProcessStep[]> = {
  pt: [
    ...
    },
    {
      ...
      description: 'Checagem cadastral, conferência de recebíveis junto aos órgãos emissores e validação de compliance via esteira automatizada.',
...
export const FAQ_DATA_BY_LANG: Record<Language, FaqItem[]> = {
  pt: [
    ...
    {
      question: 'Quais documentos preciso enviar para antecipar um recebível?',
      answer: 'Para a análise preliminar, basta enviar o Contrato Administrativo assinado, o comprovante do recebível/nota homologada válida emitida pelo órgão público e a medição/nota fiscal correspondente (caso já emitida), além dos documentos cadastrais básicos da empresa (Contrato Social e balanço recente).'
    },
    {
      question: 'Em quanto tempo sai a análise?',
      answer: 'A análise documental e checagem de veracidade do recebível junto ao órgão contratante é concluída em média em até 72 horas úteis. Após a assinatura do termo de cessão, a liquidação dos recursos ocorre no mesmo dia.'
    },
    {
    ...
    {
      question: 'Como faço para ter capital de giro?',
      answer: 'Para ter capital de giro com a XD Capital, você pode antecipar recebíveis de contratos públicos ou privados, duplicatas mercantis e vendas a prazo com total agilidade. Basta entrar em contato com nossos especialistas, enviar os dados da sua empresa e a documentação dos recebíveis para uma análise rápida em até 72 horas, com liberação do recurso diretamente na sua conta PJ.'
    },
    {
      question: 'Posso antecipar recebíveis de contratos privados ou cartões?',
      answer: 'Sim. Além da especialidade em recebíveis públicos, realizamos antecipação de recebíveis de duplicatas mercantis privadas, cartões de crédito e contratos corporativos com taxas competitivas e liquidação rápida em conta PJ.'
    }
  ],
  en: [
    {
    ...
    {
      question: 'How do I access working capital for my business?',
      answer: 'To access working capital with XD Capital, you can advance receivables from public or corporate contracts, trade bills, and commercial sales with immediate liquidity. Simply reach out to our team, submit your company details and receivable documentation for fast review within 72 hours, with direct disbursement to your corporate account.'
    },
    {
  ...
  es: [
    ...
    },
    {
      ...
      answer: 'Para la evaluación preliminar, basta enviar el Contrato Administrativo firmado, el comprobante de cuenta por cobrar/compromiso válido emitido por el organismo público y la factura correspondiente, además de los documentos constitutivos de la empresa.'
    },
    {
    ...
    {
      question: '¿Cómo hago para tener capital de trabajo?',
      answer: 'Para acceder a capital de trabajo con XD Capital, su empresa puede anticipar cuentas por cobrar de contratos públicos o privados, facturas comerciales y ventas a plazo con liquidez inmediata. Solo comuníquese con nuestro equipo y envíe la documentación para un análisis ágil en hasta 72 horas, con desembolso directo en su cuenta empresarial.'
    },
    {
