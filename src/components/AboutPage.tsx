  ...
  return (
    <div className="min-h-screen bg-[#FAFAFC] text-[#0B0F19] pt-28 pb-20 px-6">
      <div className="max-w-[1080px] mx-auto">
        ...
        {/* Hero Header */}
        <div className="mb-14">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#A3192E]/[0.08] border border-[#A3192E]/20 text-[#A3192E] text-[12.5px] font-mono mb-5">
            {isEn ? "ABOUT XD CAPITAL" : (isEs ? "CONOZCA XD CAPITAL" : "CONHEÇA A XD CAPITAL")}
          </div>
        ...
        <div className="bg-white border border-slate-200/90 rounded-[28px] p-8 sm:p-14 shadow-sm mb-12 space-y-12">
          ...
          <div className="pt-8 border-t border-slate-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-6">
                  ...
                  <p className="text-[13.5px] text-slate-600 leading-relaxed">
                    {isEn 
                      ...
                      : (isEs 
                        ...
                        : "Profundo domínio das leis de licitações, empenhos municipais, estaduais e federais, medições de obras e contratos de fornecimento contínuo.")}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5 p-4 rounded-xl bg-slate-50/60 border border-slate-200/60">
                ...
                <div>
                  <h4 className="text-[15px] font-normal text-slate-900 mb-1">{isEn ? "Contract Analysis within 72h" : (isEs ? "Evaluación de Contratos en 72h" : "Análise de Empenhos em 72h")}</h4>
                  <p className="text-[13.5px] text-slate-600 leading-relaxed">
                    {isEn
          ...
          <div className="pt-8 border-t border-slate-100">
            ...
            <p className="text-[15.5px] text-slate-600 leading-relaxed mb-6">
              {isEn 
                ? "XD Capital adopts rigorous corporate governance standards, including institutional Anti-Money Laundering (AML/CFT) screening, continuous data privacy protection compliance (LGPD), and independent ombudsman channels to ensure security for all stakeholders."
                : (isEs 
                  ? "XD Capital adopta rigurosas prácticas de gobernanza corporativa, incluyendo prevención de lavado de dinero (PLD/FT), cumplimiento continuo de protección de datos (LGPD) y defensoría independiente."
                  : "A XD Capital adota as mais rigorosas práticas de governança corporativa, incluindo programas consolidados de Prevenção à Lavagem de Dinheiro e ao Financiamento do Terrorismo (PLD/FT), conformidade contínua com a Lei Geral de Proteção de Dados (LGPD) e ouvidoria independente para assegurar total tranquilidade a nossos clientes e parceiros.")}
            </p>
