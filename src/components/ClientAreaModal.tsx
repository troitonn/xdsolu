    ...
    >
      ...
      >
        ...
        {authSuccess ? (
          ...
          <div>
            <div className="flex items-center justify-between gap-4 mb-5 pr-8">
              <img
                src="/xd-logo.png"
                alt="XD Capital"
                ...
                height={28}
              />
              <div className="flex items-center gap-1.5 text-[#A3192E] font-mono text-[10.5px] font-normal">
                <Lock className="w-3 h-3" />
                <span>{isEn ? 'ENCRYPTED' : (isEs ? 'CIFRADO' : 'CRIPTOGRAFADO')}</span>
              </div>
            </div>
