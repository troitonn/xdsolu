        ...
        {submitted ? (
          <div className="py-10 text-center flex flex-col items-center">
            ...
            <p className="body-text text-[15.5px] max-w-[440px] text-center text-slate-600 mb-8">
              {isEn 
                ? 'Our technical corporate credit desk has received your request and will contact you within 4 business hours with tailored conditions.'
                : (isEs 
                  ? 'Nuestra mesa técnica de crédito corporativo ha recibido sus datos y se comunicará en hasta 4 horas hábiles.'
                  : 'Nossa mesa técnica de crédito corporativo já recebeu seus dados e entrará em contato em até 4 horas úteis para apresentar as condições sob medida.')}
            </p>
          ...
          <div>
            ...
            <div className="mb-6 pr-8">
              <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-[#A3192E]/10 border border-[#A3192E]/30 text-[11px] font-mono text-[#A3192E] font-normal mb-2">
                {isEn ? 'CORPORATE OPERATIONS DESK' : (isEs ? 'MESA DE OPERACIONES CORPORATIVAS' : 'MESA DE OPERAÇÕES CORPORATIVAS')}
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-2">
                ...
                >
                  <span>{isEn ? 'Send to Operations Desk' : (isEs ? 'Enviar a Mesa de Análisis' : 'Enviar para Mesa de Análise')}</span>
