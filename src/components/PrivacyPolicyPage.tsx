        ...
        <div className="bg-white border border-slate-200/90 rounded-[24px] p-8 sm:p-12 shadow-sm space-y-10 leading-relaxed text-[15.5px] text-slate-700">
          ...
          <section className="space-y-3">
            ...
            <ul className="space-y-2.5 list-disc pl-5 text-slate-600">
              ...
              <li><strong>Dados Financeiros e Cadastrais:</strong> Dados bancários para liquidação, faturamento médio mensal, volume de transações e informações de recebíveis ou contratos públicos para estruturação de crédito.</li>
