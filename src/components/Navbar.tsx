...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navItems = [
    ...
    { label: t('nav.credito') || 'Crédito', href: '#folha-consignado', type: 'anchor' as const },
      ...
      >
        <div className="max-w-[1240px] mx-auto px-6 flex items-center justify-between">
          ...
          <button
            ...
            id="brand-logo"
            className="group flex items-center select-none outline-none focus-visible:ring-2 focus-visible:ring-[#A3192E] rounded-md text-left cursor-pointer transition-opacity hover:opacity-90 py-1"
            aria-label="XD Capital - Início"
          >
            <img
              src="/xd-logo.png"
              alt="XD Capital"
              className="h-8 sm:h-9 md:h-9.5 w-auto object-contain transition-transform duration-300 group-hover:scale-[1.02]"
              width={157}
              height={36}
            />
          </button>
