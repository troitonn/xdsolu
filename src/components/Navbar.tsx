...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navItems = [
    {
      label: t('nav.solutions') || 'Soluções',
      href: '#solucoes',
      type: 'anchor' as const,
    },
    {
      label: t('nav.payroll') || 'Folha & Consignado',
      href: '#folha-consignado',
      type: 'anchor' as const,
    },
    {
      label: t('nav.about') || 'Sobre a XD',
      view: 'sobre-a-xd' as AppView,
      type: 'view' as const,
    },
    {
      label: t('nav.xdpay') || 'XD Pay',
      href: '#xd-pay',
      type: 'xdpay' as const,
    },
  ];
              ...
              if (item.type === 'xdpay') {
                return (
                  <a
                    ...
                    className="nav-link flex items-center py-1 text-slate-700 hover:text-[#0B0F19] transition-colors cursor-pointer"
                    aria-label="XD Pay"
                  >
                    <img
                      src={xdpayLogo}
              ...
              if (item.type === 'xdpay') {
                return (
                  <a
                    ...
                    className="flex items-center text-left text-slate-900 hover:text-[#A3192E] transition-colors"
                    aria-label="XD Pay"
                  >
                    <img
                      src={xdpayLogo}
