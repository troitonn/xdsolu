            ...
            <ul className="space-y-3 text-[14.5px] text-slate-600">
              ...
              <li>
                <a
                  ...
                  className="hover:text-[#0B0F19] hover:underline transition-colors"
                >
                  {isEn ? 'Private Payroll Loans' : (isEs ? 'Crédito de Nómina Privada' : 'Consignado Privado')}
                </a>
              </li>
              <li>
                <a
                  ...
                  className="hover:text-[#0B0F19] hover:underline transition-colors"
                >
                  {isEn ? 'Public Sector Payroll Loans' : (isEs ? 'Crédito de Nómina Pública' : 'Consignado Público')}
                </a>
              </li>
              <li>
                <a
            ...
            <ul className="space-y-3 text-[14.5px] text-slate-600">
              ...
              <li>
                <button
                  ...
                  className="hover:text-[#0B0F19] hover:underline transition-colors text-left cursor-pointer"
                >
                  {isEn ? 'Careers' : (isEs ? 'Trabaja con nosotros' : 'Trabalhe conosco')}
                </button>
              </li>
            </ul>
          </div>
