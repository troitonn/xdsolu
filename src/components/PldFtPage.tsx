...
import { ArrowLeft, ShieldCheck, FileText, Lock, Building2, CheckCircle2 } from 'lucide-react';
      ...
      <div className="max-w-[1020px] mx-auto">
        ...
        <div className="bg-white border border-slate-200/90 rounded-[24px] p-8 sm:p-12 shadow-sm space-y-10 leading-relaxed text-[15px] sm:text-[15.5px] text-slate-700 mb-12">
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100">
            ...
            <div className="space-y-4 pt-1">
              <div>
                <h3 className="text-[16px] font-normal text-slate-900 mb-1">4.1 Administração</h3>
                <p className="text-slate-600 mb-2">Compete aos sócios e administradores:</p>
              ...
              <div>
                <h3 className="text-[16px] font-normal text-slate-900 mb-1">4.2 Responsável Interno por PLD/FT</h3>
                <p className="text-slate-600 mb-2">
                  A XD Capital designará formalmente um responsável interno pelo acompanhamento do programa de PLD/FT (&quot;Responsável PLD/FT&quot;), que atuará como interlocutor com o Liquidante parceiro e com as áreas internas. São atribuições do Responsável PLD/FT:
                </p>
                <ul className="space-y-1 list-none pl-2 text-slate-600">
                ...
                <p className="text-[13.5px] text-slate-500 bg-slate-50 border border-slate-200 rounded-lg p-3 mt-2">
              ...
              <div>
                <h3 className="text-[16px] font-normal text-slate-900 mb-1">4.3 Área Operacional</h3>
                <p className="text-slate-600 mb-2">Compete às áreas operacionais:</p>
                <ul className="space-y-1 list-none pl-2 text-slate-600">
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100">
            ...
            <p><strong>6.4.</strong> Atualizações cadastrais ocorrerão periodicamente, observando os seguintes intervalos mínimos por nível de risco:</p>
            <ul className="space-y-1 list-none pl-2 text-slate-600">
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100">
            ...
            <p><strong>7.1.</strong> Clientes e operações serão classificados nas seguintes categorias, com base nos fatores de risco identificados na Avaliação Interna:</p>
            <ul className="space-y-1 list-none pl-2 text-slate-600">
              <li>– <strong>Baixo Risco</strong></li>
              <li>– <strong>Médio Risco</strong></li>
              <li>– <strong>Alto Risco</strong></li>
              <li>– <strong>Risco Crítico</strong></li>
            </ul>
            <p>
        ...
        <div className="p-6 rounded-[20px] bg-slate-100 border border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <div className="text-[13.5px] text-slate-500 font-mono mt-0.5">pld@xdcapital.com.br · ouvidoria@xdcapital.com.br</div>
          </div>
          <button
