...
import payrollExecutiveImg from '../assets/images/payroll_executive_1786930714479.jpg';
...
export const PayrollConsignedSection: React.FC<PayrollConsignedSectionProps> = ({ onOpenContact }) => {
  ...
  return (
    <section
      ...
      className="py-24 md:py-36 bg-[#F6F7FA] border-y border-slate-200/80 relative overflow-hidden"
    >
      {/* Background Image Container with Dynamic Positioning */}
      <div className="absolute inset-0 z-0 pointer-events-none select-none">
        <img
          src={payrollExecutiveImg}
          alt="Especialista em Folha e Consignado XD Capital"
          className="w-full h-full object-cover object-[78%_25%] sm:object-[82%_30%] lg:object-[86%_35%] scale-[1.02] opacity-90 transition-transform duration-1000"
          referrerPolicy="no-referrer"
        />

        {/* Sophisticated Harmonic Gradient Overlays */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#F6F7FA] via-[#F6F7FA]/95 via-45% md:via-55% to-[#F6F7FA]/30 lg:to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#F6F7FA]/80 via-transparent to-[#F6F7FA]" />

        {/* Ambient Wine/Crimson Glow Accent */}
        <div
          className="absolute -top-[10%] right-[10%] w-[500px] h-[500px] rounded-full bg-[#A3192E] opacity-[0.05] blur-[120px]"
          aria-hidden="true"
        />
        <div
