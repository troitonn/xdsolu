      ...
      <div className="max-w-[1020px] mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="text-[12.5px] text-slate-400 font-mono mt-3">
            Vigência a partir de: 2026 · Versão 2.0
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200/90 rounded-[24px] p-8 sm:p-12 shadow-sm space-y-10 leading-relaxed text-[15px] sm:text-[15.5px] text-slate-700 mb-12">
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100">
            ...
            <p><strong>3.1.</strong> O acesso aos serviços requer cadastro prévio na Plataforma, realizado exclusivamente por meio digital, sem necessidade de assinatura física ou presença em agência.</p>
            ...
            <p><strong>3.3.</strong> O usuário é responsável pela veracidade, exatidão e atualização das informações fornecidas no cadastro. O fornecimento de informações falsas ou incompletas poderá resultar no bloqueio ou encerramento da conta.</p>
            <p><strong>3.4.</strong> A XD Capital e o Liquidante reservam-se o direito de recusar, suspender ou encerrar cadastros que não atendam aos requisitos regulatórios ou que apresentem inconsistências nas informações fornecidas, sem obrigação de justificativa ao usuário, observada a legislação aplicável.</p>
            <p><strong>3.5.</strong> O usuário é responsável pela guarda e confidencialidade de suas credenciais de acesso (login, senha, PIN, biometria). Qualquer acesso realizado com suas credenciais será presumido como realizado pelo próprio usuário.</p>
          </section>
          ...
          <section className="space-y-4 pt-6 border-t border-slate-100">
            ...
            <p><strong>4.1.</strong> A Plataforma da XD Capital, em parceria com o Liquidante, disponibiliza os seguintes serviços ao usuário:</p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 pt-1">
              <div className="bg-slate-50 border border-slate-200/90 rounded-[16px] p-4.5 space-y-1.5">
                <h3 className="text-[15px] font-normal text-slate-900">4.1 Conta de Pagamento</h3>
                <ul className="space-y-1 list-none text-[13.5px] text-slate-600">
              ...
              <div className="bg-slate-50 border border-slate-200/90 rounded-[16px] p-4.5 space-y-1.5">
                <h3 className="text-[15px] font-normal text-slate-900">4.2 Pix</h3>
                <ul className="space-y-1 list-none text-[13.5px] text-slate-600">
              ...
              <div className="bg-slate-50 border border-slate-200/90 rounded-[16px] p-4.5 space-y-1.5">
                <h3 className="text-[15px] font-normal text-slate-900">4.3 TED e Boleto</h3>
                <ul className="space-y-1 list-none text-[13.5px] text-slate-600">
              ...
              <div className="bg-slate-50 border border-slate-200/90 rounded-[16px] p-4.5 space-y-1.5">
                <h3 className="text-[15px] font-normal text-slate-900">4.4 Pagamento de Contas</h3>
                <ul className="space-y-1 list-none text-[13.5px] text-slate-600">
                  <li><strong>I —</strong> pagamento de contas de consumo, tributos, guias e cobranças com código de barras ou QR Code;</li>
                  <li><strong>II —</strong> agendamento de pagamentos.</li>
                </ul>
              </div>

              <div className="bg-slate-50 border border-slate-200/90 rounded-[16px] p-4.5 space-y-1.5">
                <h3 className="text-[15px] font-normal text-slate-900">4.5 Transações entre Contas</h3>
                <ul className="space-y-1 list-none text-[13.5px] text-slate-600">
              ...
              <div className="bg-slate-50 border border-slate-200/90 rounded-[16px] p-4.5 space-y-1.5">
                <h3 className="text-[15px] font-normal text-slate-900">4.6 Cartão</h3>
                <ul className="space-y-1 list-none text-[13.5px] text-slate-600">
                  <li><strong>I —</strong> emissão de cartão de débito e/ou pré-pago, físico ou virtual, vinculado à Conta de Pagamento;</li>
                  <li><strong>II —</strong> compras nacionais e internacionais nas redes credenciadas;</li>
                  <li><strong>III —</strong> bloqueio, desbloqueio e cancelamento do cartão pela Plataforma.</li>
                </ul>
              </div>
            </div>

            <p className="text-[14.5px] text-slate-600 pt-2">
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100">
            ...
            <p><strong>5.1.</strong> As tarifas aplicáveis aos serviços estão descritas na Tabela de Tarifas disponível dentro da Plataforma, na área de tarifas e encargos, atualizadas periodicamente.</p>
            <p><strong>5.2.</strong> A contratação de qualquer serviço sujeito a tarifa implica a concordância do usuário com os valores vigentes no momento da transação.</p>
            <p><strong>5.3.</strong> Alterações nas tarifas serão comunicadas ao usuário com antecedência mínima de 30 (trinta) dias, por meio dos canais de comunicação da XD Capital. O uso continuado da Plataforma após o prazo de comunicação implica aceitação dos novos valores.</p>
            <p><strong>5.4.</strong> Tarifas do Liquidante relativas à operação da Conta de Pagamento seguem o contrato celebrado entre o usuário e o Liquidante, disponível nos canais do Liquidante.</p>
          </section>
          ...
          <section className="space-y-4 pt-6 border-t border-slate-100">
            ...
            <div className="space-y-3">
              <h3 className="text-[16px] font-normal text-slate-900">6.1 Responsabilidades da XD Capital</h3>
              <p><strong>6.1.1. A XD Capital é responsável por:</strong></p>
              ...
              <p className="pt-2"><strong>6.1.2. A XD Capital não é responsável por:</strong></p>
              <ul className="space-y-1 list-none pl-2 text-slate-600">
              ...
              <h3 className="text-[16px] font-normal text-slate-900 pt-3">6.2 Responsabilidades do Usuário</h3>
              <p><strong>6.2.1. O usuário é responsável por:</strong></p>
              <ul className="space-y-1 list-none pl-2 text-slate-600">
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100">
            ...
            <p><strong>7.1.</strong> A XD Capital ou o Liquidante poderão suspender ou encerrar o acesso do usuário à Plataforma nas seguintes hipóteses:</p>
            <ul className="space-y-1 list-none pl-2 text-slate-600">
            ...
            <p><strong>7.2.</strong> O encerramento voluntário da conta pelo usuário pode ser solicitado a qualquer momento pelos canais de atendimento, observadas as obrigações financeiras pendentes.</p>
            <p><strong>7.3.</strong> O encerramento da conta não extingue obrigações financeiras já assumidas pelo usuário.</p>
          </section>
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100">
            ...
            <p>
              <strong>8.1.</strong> O tratamento de dados pessoais do usuário é realizado nos termos da Política de Privacidade da XD Capital, disponível em <strong>www.xdcapital.com.br/privacidade</strong>, em estrita conformidade com a Lei nº 13.709/2018 (LGPD).
            </p>
            <p>
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100">
            ...
            <ul className="space-y-1.5 list-none pl-2 text-slate-600">
              <li><strong>I — E-mail:</strong> atendimento@xdcapital.com.br / ouvidoria@xdcapital.com.br</li>
              <li><strong>II — Telefone / WhatsApp:</strong> (11) 3181-7920 (horário comercial, dias úteis das 09h às 18h)</li>
            </ul>
            <p>
              <strong>9.2.</strong> Reclamações não solucionadas nos canais de atendimento poderão ser direcionadas ao Liquidante ou ao Banco Central do Brasil, por meio do portal <strong>www.bcb.gov.br</strong>.
            </p>
            <p>
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100">
            ...
            <p><strong>10.1.</strong> Todos os elementos da Plataforma, incluindo marca, logotipo, design, textos, imagens e software, são de titularidade da XD Capital ou licenciados por terceiros, sendo vedada a sua reprodução, distribuição ou uso sem autorização expressa.</p>
            <p><strong>10.2.</strong> O acesso à Plataforma não transfere ao usuário qualquer direito de propriedade intelectual sobre seus elementos.</p>
          </section>
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100">
            ...
            <p><strong>11.1.</strong> Estes Termos são regidos pela legislação brasileira. Fica eleito o foro da comarca do domicílio do usuário para resolução de conflitos decorrentes destes Termos, nos termos do art. 101, I do CDC, quando aplicável.</p>
            <p><strong>11.2.</strong> A XD Capital poderá atualizar estes Termos a qualquer momento, comunicando o usuário com antecedência mínima de 30 (trinta) dias por meio dos canais de comunicação da Plataforma. O uso continuado após o prazo de comunicação implica aceitação das alterações.</p>
            <p><strong>11.3.</strong> A tolerância quanto ao descumprimento de qualquer disposição destes Termos não implica novação ou renúncia ao direito de exigir seu cumprimento.</p>
            <p><strong>11.4.</strong> Caso qualquer cláusula destes Termos seja considerada nula ou ineficaz, as demais permanecerão em pleno vigor.</p>
            <p><strong>11.5.</strong> Estes Termos entram em vigor na data de sua publicação na Plataforma, substituindo versões anteriores.</p>
          </section>
        </div>
        ...
        <div className="p-6 rounded-[20px] bg-slate-100 border border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <div className="text-[15px] font-normal text-slate-900">Dúvidas sobre estes Termos de Uso?</div>
            <div className="text-[13.5px] text-slate-500 font-mono mt-0.5">atendimento@xdcapital.com.br · (11) 3181-7920</div>
          </div>
