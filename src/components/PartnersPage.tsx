    ...
    <main className="partners-page">
      ...
      <section className="partners-hero">
        <div className="partners-container">
          ...
          <a href="#inscricao" className="partners-primary-button">
            Quero ser parceiro
          </a>
        </div>
      </section>
      ...
      <section className="partners-benefits">
        <div className="partners-container">
          <div className="partners-section-header">
            <span className="partners-eyebrow">POR QUE SER PARCEIRO</span>
      ...
      <section className="partners-steps">
        <div className="partners-container">
          <div className="partners-section-header">
            <span className="partners-eyebrow">COMO FUNCIONA</span>
      ...
      <section className="partners-closing">
        <div className="partners-container">
          <span className="partners-eyebrow">VAMOS CRESCER JUNTOS</span>
