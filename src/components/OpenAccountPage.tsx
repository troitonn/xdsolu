...
export const OpenAccountPage: React.FC<OpenAccountPageProps> = ({
  ...
  const serviceOptions = [
    ...
    },
    {
      id: 'recebiveis',
      icon: CreditCard,
      title: isEn ? 'Receivables & Invoices Advance' : (isEs ? 'Anticipo de Facturas y Contratos' : 'Antecipação de Recebíveis & Contratos'),
      desc: isEn ? 'Fast liquidity and invoice factoring desk' : (isEs ? 'Liquidez predecible y monetización de contratos' : 'Liquidez ágil e monetização de contratos e recebíveis públicos'),
    },
    {
      id: 'maquininhas',
      icon: Layers,
      ...
      <header className="w-full px-6 py-6 sm:px-12 flex items-center justify-between border-b border-transparent">
        ...
        <div className="flex items-center justify-center">
          <button
            ...
            className="flex items-center group focus-visible:outline-none cursor-pointer transition-opacity hover:opacity-90"
                  ...
                  <div className="space-y-4 pt-1">
                    ...
                    {accountType === 'PJ' && (
                      <div>
                        ...
                        >
                          <option value="Fornecedor Setor Público / Licitações">Fornecedor Setor Público / Licitações & Recebíveis</option>
                  ...
                  <div>
                    ...
                    <p className="text-[15px] sm:text-[16px] text-slate-500">
                      {isEn
                        ...
                        : 'Verifique seus dados antes de submeter a sua proposta'}
                    </p>
                  </div>
