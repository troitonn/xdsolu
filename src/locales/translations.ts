...
export const translations: Record<Language, LocalizedContent> = {
  pt: {
    ...
    'stats.time.num': '72h',
    'stats.time.label': 'prazo médio de análise de recebível',
    'stats.bacen.num': '100%',
    ...
    'process.step2.desc': 'Checagem cadastral, conferência de recebíveis junto aos órgãos e sacados e validação de compliance via esteira automatizada.',
    ...
    'footer.ouvidoria': 'Código de Ética',
    'footer.pldft': 'PLD/FT',
  ...
  en: {
    ...
    'footer.ouvidoria': 'Code of Ethics',
    'footer.pldft': 'PLD/FT',
